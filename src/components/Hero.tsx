...
import { ARAVIND, ARAVIND_ADDRESS, ARAVIND_EMAIL } from "../personalDetails/data";

const getYearDiffFromJuly2021 = () => {
  const startDate = new Date('2019-01-01'); // start date of my career 😇
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              {getYearDiffFromJuly2021() - 1}+ years of experience in building web
              ...
              >
                ...
                <div>
                  <span className="font-semibold text-gray-900">
                    AI-focused Frontend & Full‑Stack Engineer
                  </span>
                  <div className="text-sm text-gray-500">
                    Building accessible, performant web apps
                  </div>
                </div>
              </motion.div>
            ...
            <div className="flex space-x-4">
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                href="https://github.com/AravindMurgan"
                target="_blank"
              ...
              <motion.a
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                href="https://www.linkedin.com/in/aravindmurgan/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-gray-100 rounded-full hover:bg-gray-200"
              >
              ...
              <motion.a
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                href="mailto:mi.arvindmurugan@gmail.com"
                className="p-2 bg-gray-100 rounded-full hover:bg-gray-200"
              >
